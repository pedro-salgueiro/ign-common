 ...
 *
*/
#ifndef _IGNITION_COMMON_MESHEXPORTER_HH_
#define _IGNITION_COMMON_MESHEXPORTER_HH_
...
namespace ignition
{
  namespace common
  {
    ...
    /// \class MeshExporter MeshExporter.hh common/MeshExporter.hh
    /// \brief Base class for exporting meshes
    class IGNITION_VISIBLE MeshExporter
    {
      /// \brief Constructor
      public: MeshExporter();
