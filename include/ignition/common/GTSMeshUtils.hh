...
#ifndef _IGNITION_COMMON_GTSMESHUTILS_HH_
#define _IGNITION_COMMON_GTSMESHUTILS_HH_
...
namespace ignition
{
  namespace common
  {
    ...
    /// \class GTSMeshUtils GTSMeshUtils.hh common/GTSMeshUtils.hh
    /// \brief Creates GTS utilities for meshes
    class IGNITION_VISIBLE GTSMeshUtils
    {
