 ...
 *
*/
#ifndef _IGNITION_COMMON_STLLOADER_HH_
#define _IGNITION_COMMON_STLLOADER_HH_
...
namespace ignition
{
  namespace common
  {
    /// \class STLLoader STLLoader.hh common/STLLoader.hh
    /// \brief Class used to load STL mesh files
    class IGNITION_VISIBLE STLLoader : public MeshLoader
    {
      /// \brief Constructor
      public: STLLoader();
