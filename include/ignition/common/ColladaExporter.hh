...
#ifndef _IGNITION_COMMON_COLLADAEXPORTER_HH_
#define _IGNITION_COMMON_COLLADAEXPORTER_HH_
...
namespace ignition
{
  namespace common
  {
    ...
    /// \class ColladaExporter ColladaExporter.hh common/ColladaExporter.hh
    /// \brief Class used to export Collada mesh files
    class IGNITION_VISIBLE ColladaExporter : public MeshExporter
    {
