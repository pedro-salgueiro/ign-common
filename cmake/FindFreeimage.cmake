...
if (NOT freeimage_FOUND)
  ...
  if (NOT freeimage_INCLUDE_DIRS)
    ...
    BUILD_WARNING("Missing: Unable to find FreeImage.h")
    ...
    if (NOT FREEIMAGE_RUNS)
      BUILD_WARNING("Invalid FreeImage Version. Requires ${FREEIMAGE_VERSION}")
  ...
  if (NOT freeimage_LIBRARIES)
    ...
    BUILD_WARNING("Missing: Unable to find libfreeimage")
