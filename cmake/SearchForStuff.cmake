...
if (NOT DEFINED IGNITION-MATH_LIBRARY_DIRS AND NOT DEFINED IGNITION-MATH_INCLUDE_DIRS AND NOT DEFINED IGNITION-MATH_LIBRARIES)
  ...
  if (NOT ignition-math${IGNITION-MATH_REQUIRED_MAJOR_VERSION}_FOUND)
    ...
    BUILD_WARNING ("Missing: Ignition math${IGNITION-MATH_REQUIRED_MAJOR_VERSION} library.")
  else()
...
if (NOT DEFINED USE_EXTERNAL_TINYXML2)
  ...
  elseif(WIN32)
    ...
    BUILD_WARNING("Unknown platform")
  endif()
endif()
...
if (USE_EXTERNAL_TINYXML2)
  ...
  if (tinyxml2_FAIL)
    ...
    BUILD_WARNING("Missing: tinyxml2")
  else()
    set (HAVE_TINYXML2 True)
    message (STATUS "Looking for tinyxml2.h - found")
  endif()
else()
...
if (NOT libdl_include_dir)
  ...
  BUILD_WARNING ("Missing libdl: Required for plugins.")
...
if (UNIX)
  ...
  if (gts_FOUND)
    ...
    set (HAVE_GTS FALSE)
    BUILD_WARNING ("GNU Triangulation Surface library not found.")
  endif ()

  if (NOT uuid_FOUND)
    message (STATUS "Looking for uuid pkgconfig file - not found")
    BUILD_WARNING ("uuid not found, Please install uuid")
  else ()
